...
function Terminal() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { ref: containerRef, className: "terminal-container" });
}
...
function AgentBuilder({ detection, onComplete, onCancel }) {
  const [messages, setMessages] = reactExports.useState([]);
  const [input, setInput] = reactExports.useState("");
  const [loading, setLoading] = reactExports.useState(false);
  const [finalAgent, setFinalAgent] = reactExports.useState(null);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "agent-builder", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "builder-header", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "builder-title", children: "에이전트 빌더" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "builder-cancel", onClick: onCancel, children: "취소" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "builder-context", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "builder-context-label", children: "감지됨" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "builder-context-text", children: detection.reason })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "builder-messages", ref: scrollRef, children: [
      messages.map((msg, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `builder-msg ${msg.role}`, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "builder-msg-label", children: msg.role === "assistant" ? "AI" : "나" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "builder-msg-text", children: msg.content })
      ] }, i)),
      loading && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "builder-msg assistant", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "builder-msg-label", children: "AI" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "builder-msg-text builder-typing", children: "생각 중..." })
      ] })
    ] }),
    finalAgent && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "builder-preview", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "builder-preview-header", children: "에이전트 미리보기" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "builder-preview-field", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { children: "이름" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: finalAgent.name })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "builder-preview-field", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { children: "설명" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: finalAgent.description })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "builder-preview-field", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { children: "시스템 프롬프트" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "builder-preview-prompt", children: finalAgent.systemPrompt })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "builder-confirm", onClick: () => onComplete(finalAgent), children: "이 에이전트 생성하기" })
    ] }),
    !finalAgent && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "builder-input-area", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "builder-send", onClick: handleSend, disabled: loading || !input.trim(), children: "전송" })
    ] })
  ] });
}
function AgentCard({ agent, onSelect }) {
  const { toggleAgent, deleteAgent } = useAgentStore();
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "agent-card", onClick: () => onSelect(agent), children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "agent-card-header", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "agent-name", children: agent.name }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "agent-actions", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            ...
            children: agent.status === "active" ? "ON" : "OFF"
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "agent-description", children: agent.description }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `agent-status ${agent.status}`, children: agent.status === "active" ? "활성" : "일시정지" })
  ] });
}
function AgentDetail({ agent, onBack, onRun }) {
  const { toggleAgent, deleteAgent, updateAgent } = useAgentStore();
  const [editing, setEditing] = reactExports.useState(false);
  const [editName, setEditName] = reactExports.useState(agent.name);
  const [editDesc, setEditDesc] = reactExports.useState(agent.description);
  const [editPrompt, setEditPrompt] = reactExports.useState(agent.system_prompt);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "agent-detail", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "agent-detail-header", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "agent-detail-back", onClick: onBack, children: "← 목록" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "agent-detail-actions", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            className: `toggle-btn ${agent.status === "active" ? "active" : ""}`,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "delete-btn", onClick: () => {
          deleteAgent(agent.id);
          onBack();
        }, children: "삭제" })
      ] })
    ...
    !editing ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "agent-detail-section", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { children: "이름" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "agent-detail-value", children: agent.name })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "agent-detail-section", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { children: "설명" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "agent-detail-value", children: agent.description })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "agent-detail-section", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { children: "시스템 프롬프트" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("pre", { className: "agent-detail-prompt", children: agent.system_prompt })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "agent-detail-section", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { children: "상태" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `agent-status ${agent.status}`, children: agent.status === "active" ? "활성" : "일시정지" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "agent-detail-section", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { children: "생성일" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "agent-detail-value agent-detail-date", children: new Date(agent.created_at).toLocaleString("ko-KR") })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "agent-detail-buttons", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "agent-detail-edit-btn", onClick: () => setEditing(true), children: "편집" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "agent-detail-run-btn", onClick: () => onRun(agent), children: "실행" })
      ] })
    ] }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "agent-detail-section", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { children: "이름" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("input", { className: "form-input", value: editName, onChange: (e) => setEditName(e.target.value) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "agent-detail-section", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { children: "설명" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("input", { className: "form-input", value: editDesc, onChange: (e) => setEditDesc(e.target.value) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "agent-detail-section", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { children: "시스템 프롬프트" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("textarea", { className: "form-textarea agent-detail-prompt-edit", value: editPrompt, onChange: (e) => setEditPrompt(e.target.value), rows: 10 })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "agent-detail-buttons", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "agent-detail-edit-btn", onClick: () => setEditing(false), children: "취소" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "agent-detail-run-btn", onClick: handleSave, disabled: saving, children: saving ? "저장 중..." : "저장" })
      ] })
    ] })
  ] });
}
function DetectionCard({ detection, onAccept, onDismiss }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "detection-card", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "detection-header", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "detection-badge", children: detection.type }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "delete-btn", onClick: onDismiss, children: "✕" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "detection-reason", children: detection.reason }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "detection-suggestion", children: detection.suggestion }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "detection-agent-preview", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "detection-agent-name", children: detection.agentName }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "detection-agent-desc", children: detection.agentDescription })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "detection-accept-btn", onClick: onAccept, children: "에이전트 만들기" })
  ] });
}
function CreateAgentForm({ onClose }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "agent-create-form", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "form-header", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "새 에이전트" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "delete-btn", onClick: onClose, children: "✕" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "input",
      {
...
function AgentList() {
  ...
  const [buildingDetection, setBuildingDetection] = reactExports.useState(null);
  ...
  const handleDismissDetection = (detection) => {
    setDetections((prev) => prev.filter((d) => d !== detection));
  };
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "agent-list", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "agent-list-toolbar", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
    ...
    detections.map((d, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      DetectionCard,
      {
        detection: d,
    ...
    showForm && /* @__PURE__ */ jsxRuntimeExports.jsx(CreateAgentForm, { onClose: () => setShowForm(false) }),
    loading && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "agent-list-empty", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "로딩 중..." }) }),
    !loading && agents.length === 0 && !showForm && detections.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "agent-list-empty", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "아직 에이전트가 없습니다" }) }),
    agents.map((agent) => /* @__PURE__ */ jsxRuntimeExports.jsx(AgentCard, { agent, onSelect: setSelectedAgent }, agent.id))
  ] });
}
function Settings({ onClose, onStatusChange }) {
  const [mode, setMode] = reactExports.useState("api");
  const [provider, setProvider] = reactExports.useState("claude");
  ...
  const handleSaveApiKey = async () => {
    ...
    setMessage(null);
    try {
      await window.api.auth.loginCli("");
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "settings-overlay", onClick: onClose, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "settings-modal", onClick: (e) => e.stopPropagation(), children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "settings-header", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "LLM 설정" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "settings-close", onClick: onClose, children: "✕" })
    ] }),
    ...
    mode === "cli" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "settings-section", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "settings-desc", children: [
        "Claude CLI 구독을 사용합니다. 터미널에서 ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("code", { children: "claude" }),
        " 명령이 동작해야 합니다."
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          ...
          disabled: saving,
          children: saving ? "설정 중..." : "CLI 모드 활성화"
        }
      )
    ] }),
    mode === "api" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "settings-section", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "settings-provider-select", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
    ...
    message && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `settings-message ${message.type}`, children: message.text })
  ] }) });
}
function App() {
  const agents = useAgentStore((s) => s.agents);
  const activeCount = agents.filter((a) => a.status === "active").length;
  const [leftWidth, setLeftWidth] = reactExports.useState(320);
  const isDragging = reactExports.useRef(false);
  const [llmStatus, setLlmStatus] = reactExports.useState("disconnected");
  const [showSettings, setShowSettings] = reactExports.useState(false);
  const [agentResponse, setAgentResponse] = reactExports.useState(null);
  const [agentWorking, setAgentWorking] = reactExports.useState(null);
  reactExports.useEffect(() => {
    window.api.auth.getConfig().then((config) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "app", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "app-layout", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "panel-left", style: { width: leftWidth }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "panel-header", children: "Agents" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "panel-content", children: /* @__PURE__ */ jsxRuntimeExports.jsx(AgentList, {}) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "divider", onMouseDown: handleMouseDown }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "panel-right", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "panel-header", children: [
          "Terminal",
          agentWorking && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "agent-working-badge", children: [
            agentWorking,
            " 작업 중..."
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "panel-content", style: { display: "flex", flexDirection: "column" }, children: [
          agentResponse && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "agent-response-panel", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "agent-response-header", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "agent-response-name", children: agentResponse.agentName }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "agent-response-close", onClick: () => setAgentResponse(null), children: "✕" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("pre", { className: "agent-response-body", children: agentResponse.response })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { flex: 1, minHeight: 0 }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Terminal, {}) })
        ] })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "status-bar", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "status-item", children: "Light Code v0.1.0" }),
